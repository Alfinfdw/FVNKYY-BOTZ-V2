        ...
        case 'pet':
            ...
            if (global.db.data.users[m.sender].pet > 0) { 
                ...
                if (_pet == 'kucing' && kucing > 0) {
                    ...
                    global.db.data.users[m.sender].makananpet += mknp * 1
                    m.reply(pickRandom(['Anda kurang Beruntung!', 'Coba buka lagi lain kali, karena gak dapet pet', 'kasian gak dapet pet:v', 'Mungkin lagi gak Hoki dan gak dapet pet', 'wkwkkwkwke']) + '. Anda hanya mendapatkan *' + mknp + '* makanan pet')
                }
            } else m.reply('PET CREATE KAMU TIDAK CUKUP!')
            break
        default:
