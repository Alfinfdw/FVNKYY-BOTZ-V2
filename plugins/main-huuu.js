...
conn.sendImageAsSticker(m.chat, pickRandom(stikerhuuu), m, { packname: "sticker by", author: "Andika" })
}

handler.customPrefix = /^huu|hu|huuu|hoo|hooo|y|Y|Pftt|pftt|F$/i
...
let stikerhuuu = [
 ...
 "https://telegra.ph/file/dfbf483c209a31f01b4e5.png"//hengker
]
